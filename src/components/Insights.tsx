...
import { TrendingUp, PieChart, BarChart2, Droplets, Wind, Globe, ArrowLeft, Leaf } from 'lucide-react';
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium">Deep dive into your sustainability metrics and social impact.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          <GlassCard className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white border-none shadow-2xl shadow-emerald-500/20">
            <div className="flex flex-col items-center text-center py-6">
               ...
               <p className="text-emerald-50 text-sm font-medium leading-relaxed px-4">
                 Your institution is in the <span className="underline italic">top 5%</span> of surplus redistributors in the region.
               </p>
            </div>
          </GlassCard>
          ...
          <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 flex flex-col items-center text-center">
             ...
             <h4 className="font-black text-slate-800">Monthly Reports</h4>
             <p className="text-slate-400 text-xs font-medium mb-6">Download your detailed sustainability certificate for March 2024.</p>
             <button className="w-full py-3 bg-slate-900 text-white rounded-2xl font-black text-sm shadow-xl shadow-slate-900/10 hover:bg-emerald-600 transition-all">
               Generate PDF
             </button>
          </div>
        </div>
